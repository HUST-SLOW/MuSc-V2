...
class MVTec3dDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.source = source
        self.cls = classname
        self.img_path = os.path.join(source, self.cls, self.split)
    ...
    def load_dataset(self):
        ...
        data_to_iterate = [(self.cls, tot_labels[i], img_tot_paths[i], gt_tot_paths[i]) for i in range(len(img_tot_paths))]
